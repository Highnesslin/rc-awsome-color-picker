...
export default class HexInput extends PureComponent<Props, State> {
  ...
  _correctInput = (value: string) => value.toUpperCase().replace(/[^0-9A-F]/g, '').slice(0, 6)
  ...
  render() {
    ...
    const inputValue = [undefined, null, STANDARD_TRANSPARENT, TRANSPARENT].includes(hexValue) ? 'FFFFFF' : hexValue
